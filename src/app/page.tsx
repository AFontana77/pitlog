...
export const metadata: Metadata = {
  ...
  description: "Every BBQ cut with its USDA safe temp, the pitmaster finish, the wood and the recipe. Log every cook and keep what worked. Free on iPhone and Android.",
};
