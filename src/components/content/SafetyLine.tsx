 ...
 */
export function SafetyLine({ safety, compact = false }: { safety: SafetyMinimum; compact?: boolean }) {
  ...
  return (
    ...
    >
      ...
      <p className="text-sm leading-relaxed" style={{ color: C.textSoft }}>
        ...
        {' '}This is a food safety floor, not a preference. Where any other number on this page is lower, this one governs.
      </p>
      {src && !compact && (
